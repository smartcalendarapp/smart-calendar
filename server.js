				...
				},*/
				{
					...
					parameters: {
						...
						properties: {
							...
							hexColor: { type: 'string', description: '(optional) Task hex color. Preset options: #ff2e2e,#ff932e,#ffe32e,#2ad143,#18a4f5,#185bf5,#8138ff' },
						},
						required: ['title']
					}
				},
				{
					...
					parameters: {
						...
						properties: {
							...
							RRULE: { type: 'string', description: 'Recurrence in RRULE format. Example: RRULE:FREQ=WEEKLY;INTERVAL=1;BYDAY=TU,TH;UNTIL=20241231T000000Z' },
							hexColor: { type: 'string', description: '(optional) Event hex color. Preset options: #ff2e2e,#ff932e,#ffe32e,#2ad143,#18a4f5,#185bf5,#8138ff' }
						},
						required: ['title']
					}
				},
				...
				},
				{
					...
					parameters: {
						...
						properties: {
							...
							newHexColor: { type: 'string', description: '(optional) Event hex color. Preset options: #ff2e2e,#ff932e,#ffe32e,#2ad143,#18a4f5,#185bf5,#8138ff' },
						},
						required: []
					}
				},
				...
				},
				{
					...
					parameters: {
						...
						properties: {
							...
							newHexColor: { type: 'string', description: '(optional) Task hex color. Preset options: #ff2e2e,#ff932e,#ffe32e,#2ad143,#18a4f5,#185bf5,#8138ff' },
						},
						required: []
					}
				},
