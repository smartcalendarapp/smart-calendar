				...
				},*/
				{
					...
					parameters: {
						...
						properties: {
							...
							hexColor: { type: 'string', description: '(optional) Task hex color' },
						},
						required: ['title']
					}
				},
				{
					...
					parameters: {
						...
						properties: {
							...
							RRULE: { type: 'string', description: 'Recurrence in RRULE format. Example: RRULE:FREQ=WEEKLY;INTERVAL=1;BYDAY=TU,TH;UNTIL=20241231T000000Z' },
							hexColor: { type: 'string', description: '(optional) Event hex color' }
						},
						required: ['title']
					}
				},
				...
				},
				{
					...
					parameters: {
						...
						properties: {
							...
							newHexColor: { type: 'string', description: '(optional) Event hex color' },
						},
						required: []
					}
				},
				...
				},
				{
					...
					parameters: {
						...
						properties: {
							...
							newHexColor: { type: 'string', description: '(optional) Task hex color' },
						},
						required: []
					}
				},
