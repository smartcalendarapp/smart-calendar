...
app.post('/getcardhint', async (req, res) => {
	...
	const systemprompt = `User needs help memorizing, use memory loci and palace, analogies, and/or word play. Make it easy to read and visualize.${showanswer ? '' : ` Don't give away the card back.`} 2-3 sentences. If studying a language, help user remember the pronounciation. If studying science, elaborate on the specific mechanisms`
