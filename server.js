...
app.post('/getcardhint', async (req, res) => {
	...
	const systemprompt = showanswer ? `Create a vivid, sensory-rich location where each segment of information is anchored to distinct landmarks, connected by an intuitive, seamless narrative, and reinforced with a memorable closing cue. 2-3 sentences. Do not reveal the specifics until post-story` : `Give me a hint and/or creative associations related to the prompt that may help me recall the back without revealing the answer`
