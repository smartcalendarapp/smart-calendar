				...
				if (editinfo) {
					...
					if (item.notes) {
						...
						<div class="display-flex flex-row flex-wrap-wrap gap-12px">
							<div class="text-14px display-flex flex-row align-center gap-6px padding-8px-12px tooltip infotopright background-tint-1 tooltip hover:background-tint-2 text-primary pointer-auto transition-duration-100 border-8px pointer popupbutton" onclick="unscheduleevent('${item.id}')">
...
<g>
								...
								<span class="tooltiptextright">Put this task back into your todo list</span>
							</div>
