...
async function autoScheduleV2(smartevents, addedtodos, resolvedpassedtodos) {
	...
	function getconflictingevent(data, item1) {
		...
		for (let item2 of sortdata) {
			...
			console.log(tempstartdate1 + '', tempstartdate2 + '', spacing, tempstartdate1.getTime() < tempenddate2.getTime() + spacing && tempenddate1.getTime() + spacing > tempstartdate2.getTime())
