...
async function likeaichatmessage(id){
	let chatinteraction = chathistory.getInteractions().find(d => d.id == id)
...
async function dislikeaichatmessage(id){
	let chatinteraction = chathistory.getInteractions().find(d => d.id == id)
	if(!chatinteraction) return
			...
			<div class="display-flex flex-row gap-12px">
				...
				<div class="overflow-hidden display-flex flex-column gap-12px">
					...
					<div class="display-flex flex-row gap-12px">
						...
						<svg height="100%" stroke-miterlimit="10" style="fill-rule:nonzero;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;" viewBox="0 0 256 256" width="100%" class="aimessagebutton padding-6px" onclick="likeaichatmessage('${chatinteraction.id}')">
						<g>
						...
						<svg height="100%" stroke-miterlimit="10" style="fill-rule:nonzero;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;" viewBox="0 0 256 256" width="100%" class="aimessagebutton padding-6px" onclick="dislikeaichatmessage('${chatinteraction.id}')">
						<g>
