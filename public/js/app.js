				...
				return new Promise((resolve) => {
					...
					const interval = setInterval(async () => {
						...
						let loadoptions = [
							...
							`<div class="chatmultiloaderitem display-flex gap-6px flex-row align-center justify-center"><span class="nowrap text-15px text-quaternary">Sorry for taking so long...</span></div>`
						]
